    ...
    <div class="order-detail">
      <div class="detail-header">
        ...
        <van-icon
          ...
          @click="cliPlayRight"
        />
        <div class="printing-btn" @click="print" v-if="$route.query.type == 1">打印批次号</div>
      </div>
      ...
      <div class="detailed">
        ...
        <div class="tiji" v-if="typeVal == 3">
          <div class="clearfix">
            <span
              class="pl-30"
            >原位置 : {{currentProduct.outRegionName?currentProduct.outRegionName:'无'}}</span>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    print() {
      ...
      if (bluetoothSocket.isConnected()) {
        ...
        console.log(this.currentProduct.batchNo, "this.currentProduct.batchNo");
